...
public class Property90 {
    ...
    private String cameraLifetime;
    private String cameraVisionRadius;
    ...
    private Property337FireTargetLayerCapsTable fireTargetLayerCapsTable;
    ...
    private Property90RackBones rackBones;
    ...
    public String getCameraLifetime() { return cameraLifetime; }
    @JsonProperty("CameraLifetime")
    public void setCameraLifetime(String value) { this.cameraLifetime = value; }

    @JsonProperty("CameraVisionRadius")
    public String getCameraVisionRadius() { return cameraVisionRadius; }
    @JsonProperty("CameraVisionRadius")
    public void setCameraVisionRadius(String value) { this.cameraVisionRadius = value; }
    ...
    public Property337FireTargetLayerCapsTable getFireTargetLayerCapsTable() { return fireTargetLayerCapsTable; }
    @JsonProperty("FireTargetLayerCapsTable")
    public void setFireTargetLayerCapsTable(Property337FireTargetLayerCapsTable value) { this.fireTargetLayerCapsTable = value; }
    ...
    public Property90RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property90RackBones value) { this.rackBones = value; }
