...
public class Property1483 {
    ...
    private Property1483RackBones rackBones;
    ...
    private boolean receiveROF2Buff;
    ...
    public Property1483RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property1483RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("ReceiveROF2Buff")
    public boolean getReceiveROF2Buff() { return receiveROF2Buff; }
    @JsonProperty("ReceiveROF2Buff")
    public void setReceiveROF2Buff(boolean value) { this.receiveROF2Buff = value; }
