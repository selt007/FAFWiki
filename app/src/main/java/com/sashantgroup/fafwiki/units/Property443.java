...
public class Property443 {
    ...
    private Property443RackBones rackBones;
    ...
    private ArmorType weaponCategory;
    ...
    public Property443RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property443RackBones value) { this.rackBones = value; }
    ...
    public ArmorType getWeaponCategory() { return weaponCategory; }
    @JsonProperty("WeaponCategory")
    public void setWeaponCategory(ArmorType value) { this.weaponCategory = value; }
