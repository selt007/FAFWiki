...
public class Property251 {
    private Property182Audio audio;
    private Property251Buffs buffs;
    ...
    private Property251RackBones rackBones;
    ...
    @JsonProperty("Audio")
    public Property182Audio getAudio() { return audio; }
    @JsonProperty("Audio")
    public void setAudio(Property182Audio value) { this.audio = value; }

    @JsonProperty("Buffs")
    public Property251Buffs getBuffs() { return buffs; }
    @JsonProperty("Buffs")
    public void setBuffs(Property251Buffs value) { this.buffs = value; }
    ...
    public Property251RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property251RackBones value) { this.rackBones = value; }
