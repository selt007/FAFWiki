...
public class Property180 {
    ...
    private Property180RackBones rackBones;
    ...
    private String supportedFiringRandomnessDivider;
    ...
    public Property180RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property180RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("SupportedFiringRandomnessDivider")
    public String getSupportedFiringRandomnessDivider() { return supportedFiringRandomnessDivider; }
    @JsonProperty("SupportedFiringRandomnessDivider")
    public void setSupportedFiringRandomnessDivider(String value) { this.supportedFiringRandomnessDivider = value; }
}
