...
public class Property489 {
    private Audio audio;
    private boolean autoInitiateAttackCommand;
    private String ballisticArc;
    private Property489Buffs buffs;
    private boolean bombardDisable;
    ...
    private Property489RackBones rackBones;
    ...
    @JsonProperty("Buffs")
    public Property489Buffs getBuffs() { return buffs; }
    @JsonProperty("Buffs")
    public void setBuffs(Property489Buffs value) { this.buffs = value; }

    @JsonProperty("BombardDisable")
    public boolean getBombardDisable() { return bombardDisable; }
    @JsonProperty("BombardDisable")
    public void setBombardDisable(boolean value) { this.bombardDisable = value; }
    ...
    public Property489RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property489RackBones value) { this.rackBones = value; }
