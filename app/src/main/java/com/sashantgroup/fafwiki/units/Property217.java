...
public class Property217 {
    ...
    private Property217RackBones rackBones;
    ...
    public Property217RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property217RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("TurretBoneDualYaw")
    public String getTurretBoneDualYaw() { return turretBoneDualYaw; }
    @JsonProperty("TurretBoneDualYaw")
    public void setTurretBoneDualYaw(String value) { this.turretBoneDualYaw = value; }
    ...
    @JsonProperty("TurretDualManipulatorsAlternate")
    public Boolean getTurretDualManipulatorsAlternate() { return turretDualManipulatorsAlternate; }
    @JsonProperty("TurretDualManipulatorsAlternate")
    public void setTurretDualManipulatorsAlternate(Boolean value) { this.turretDualManipulatorsAlternate = value; }
