...
public class Property204 {
    ...
    private Property204RackBones rackBones;
    ...
    private Property204Buffs buffs;
    ...
    private Boolean nukeBlackHoleFxLogo;
    ...
    public Property204RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property204RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("Buffs")
    public Property204Buffs getBuffs() { return buffs; }
    @JsonProperty("Buffs")
    public void setBuffs(Property204Buffs value) { this.buffs = value; }
    ...
    public String getShieldDamage() { return shieldDamage; }
    @JsonProperty("ShieldDamage")
    public void setShieldDamage(String value) { this.shieldDamage = value; }
    ...
    @JsonProperty("NukeBlackHoleFxLogo")
    public Boolean getNukeBlackHoleFxLogo() { return nukeBlackHoleFxLogo; }
    @JsonProperty("NukeBlackHoleFxLogo")
    public void setNukeBlackHoleFxLogo(Boolean value) { this.nukeBlackHoleFxLogo = value; }
