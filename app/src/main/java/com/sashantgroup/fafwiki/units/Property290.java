...
public class Property290 {
    ...
    public String getMuzzleVelocityRandomness() { return muzzleVelocityRandomness; }
    @JsonProperty("MuzzleVelocityRandomness")
    public void setMuzzleVelocityRandomness(String value) { this.muzzleVelocityRandomness = value; }
    ...
    public Property290RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property290RackBones value) { this.rackBones = value; }
