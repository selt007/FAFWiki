...
public class Property207 {
    ...
    private Property207RackBones rackBones;
    ...
    private MassMult firingRandomnessWhileMoving;
    private String firingToleranceWhileMoving;
    ...
    public Property207RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property207RackBones value) { this.rackBones = value; }
    ...
    public MassMult getFiringRandomnessWhileMoving() { return firingRandomnessWhileMoving; }
    @JsonProperty("FiringRandomnessWhileMoving")
    public void setFiringRandomnessWhileMoving(MassMult value) { this.firingRandomnessWhileMoving = value; }

    @JsonProperty("FiringToleranceWhileMoving")
    public String getFiringToleranceWhileMoving() { return firingToleranceWhileMoving; }
    @JsonProperty("FiringToleranceWhileMoving")
    public void setFiringToleranceWhileMoving(String value) { this.firingToleranceWhileMoving = value; }
