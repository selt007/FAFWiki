...
public class Property317 {
    ...
    private MassMult projectileLifetime;
    private Property317RackBones rackBones;
    ...
    public MassMult getProjectileLifetime() { return projectileLifetime; }
    @JsonProperty("ProjectileLifetime")
    public void setProjectileLifetime(MassMult value) { this.projectileLifetime = value; }

    @JsonProperty("RackBones")
    public Property317RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property317RackBones value) { this.rackBones = value; }
