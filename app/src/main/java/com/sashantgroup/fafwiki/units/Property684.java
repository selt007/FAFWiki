...
public class Property684 {
    ...
    private Property684RackBones rackBones;
    ...
    @JsonProperty("Buffs")
    public Property684Buffs getBuffs() { return buffs; }
    @JsonProperty("Buffs")
    public void setBuffs(Property684Buffs value) { this.buffs = value; }

    @JsonProperty("ChargeDelay")
    public String getChargeDelay() { return chargeDelay; }
    @JsonProperty("ChargeDelay")
    public void setChargeDelay(String value) { this.chargeDelay = value; }
    ...
    public Property684RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property684RackBones value) { this.rackBones = value; }
