...
public class Property220 {
    private Property220Audio audio;
    ...
    private Property220RackBones rackBones;
    ...
    private Boolean weaponUnpackChargeUpAnimation;
    private Boolean weaponUnpackLocksMotion;

    @JsonProperty("Audio")
    public Property220Audio getAudio() { return audio; }
    @JsonProperty("Audio")
    public void setAudio(Property220Audio value) { this.audio = value; }
    ...
    public Property220RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property220RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("WeaponUnpackChargeUpAnimation")
    public Boolean getWeaponUnpackChargeUpAnimation() { return weaponUnpackChargeUpAnimation; }
    @JsonProperty("WeaponUnpackChargeUpAnimation")
    public void setWeaponUnpackChargeUpAnimation(Boolean value) { this.weaponUnpackChargeUpAnimation = value; }
