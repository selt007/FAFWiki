...
public class Property346 {
    ...
    private Property346RackBones rackBones;
    ...
    private String maxRadiusUnderWater;
    private String minRadius;
    private String muzzleVelocityReduceDistance;
    private String projectileLifetime;
    private Boolean receiveMaxRadiusBuff;
    private Boolean renderFireClock;
    private String trackTargetDelay;
    private String trackTargetProjectileVelocity;
    ...
    public Property346RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property346RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("MaxRadiusUnderWater")
    public String getMaxRadiusUnderWater() { return maxRadiusUnderWater; }
    @JsonProperty("MaxRadiusUnderWater")
    public void setMaxRadiusUnderWater(String value) { this.maxRadiusUnderWater = value; }
    ...
    @JsonProperty("ReceiveMaxRadiusBuff")
    public Boolean getReceiveMaxRadiusBuff() { return receiveMaxRadiusBuff; }
    @JsonProperty("ReceiveMaxRadiusBuff")
    public void setReceiveMaxRadiusBuff(Boolean value) { this.receiveMaxRadiusBuff = value; }
    ...
    @JsonProperty("TrackTargetDelay")
    public String getTrackTargetDelay() { return trackTargetDelay; }
    @JsonProperty("TrackTargetDelay")
    public void setTrackTargetDelay(String value) { this.trackTargetDelay = value; }

    @JsonProperty("TrackTargetProjectileVelocity")
    public String getTrackTargetProjectileVelocity() { return trackTargetProjectileVelocity; }
    @JsonProperty("TrackTargetProjectileVelocity")
    public void setTrackTargetProjectileVelocity(String value) { this.trackTargetProjectileVelocity = value; }
}
