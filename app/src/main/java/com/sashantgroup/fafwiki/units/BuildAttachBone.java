...
public enum BuildAttachBone {
    ATTACHPOINT, ATTACHPOINT01, ATTACH_POINT, BUILD_ATTACH_POINT, BUILD_POINT;
    ...
    public String toValue() {
        ...
        case BUILD_ATTACH_POINT: return "BuildAttachPoint";
    ...
    public static BuildAttachBone forValue(String value) throws IOException {
        ...
        if (value.equals("BuildAttachPoint")) return BUILD_ATTACH_POINT;
