...
public enum Property100TreadMarks {
    ...
    @JsonCreator
    public static Property100TreadMarks forValue(String value) throws IOException {
        ...
        throw new IOException("Cannot deserialize Property100TreadMarks");
    }
}
