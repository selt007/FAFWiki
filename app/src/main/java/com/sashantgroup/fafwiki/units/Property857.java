...
public class Property857 {
    ...
    private Property172FireTargetLayerCapsTable fireTargetLayerCapsTable;
    ...
    private Property857RackBones rackBones;
    ...
    private boolean receiveROFBuff;
    ...
    public Property172FireTargetLayerCapsTable getFireTargetLayerCapsTable() { return fireTargetLayerCapsTable; }
    @JsonProperty("FireTargetLayerCapsTable")
    public void setFireTargetLayerCapsTable(Property172FireTargetLayerCapsTable value) { this.fireTargetLayerCapsTable = value; }
    ...
    public Property857RackBones getRackBones() { return rackBones; }
    @JsonProperty("RackBones")
    public void setRackBones(Property857RackBones value) { this.rackBones = value; }
    ...
    @JsonProperty("ReceiveROFBuff")
    public boolean getReceiveROFBuff() { return receiveROFBuff; }
    @JsonProperty("ReceiveROFBuff")
    public void setReceiveROFBuff(boolean value) { this.receiveROFBuff = value; }
